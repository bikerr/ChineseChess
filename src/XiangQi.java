...
public class XiangQi extends JFrame implements ActionListener{
	...
	//public static final Color colorRed =new Color(249,253,173);
	public static final Color colorWirte =new Color(255,255,255);//或者Color.wirte;
	//public static final Color colorWirte =Color.white;
	...
	//JLabel jimagered = new JLabel("../images/将。png");
	//JLabel jimagewirte = new JLabel("../images/帅。png");
	...
	{
		//this.jimagered.setOpaque(true);
		//this.jimagered.setIcon(icon1);
		//设置jpz的两个图标
		
		//添加位置（img）                  帅(685.80)  将(685,620)
		//this.jimagered.setBounds(685, 80, 100, 100);
		//this.jimagewirte.setBounds(685, 620, 100, 100);
		//jpz.add(this.jimagered);
		//jpz.add(this.jimagewirte);
		...
		///this.jimagered.setIcon(icon1);
		//this.jimagered.setBounds(200, 80, 100, 100);
		//this.jimagewirte.setBounds(200, 620, 100, 100);
		//jpy.add(this.jimagered);
		//jpy.add(this.jimagewirte);
				
		//this.setResizable(false);//固定窗口不可拖动 不可改变大小
	}
...
//	    qizi[10][9]=new QiZi(colorWirte,"将",10,3);
	}
	...
	public void jbConnect_event() {
		...
		try{
			...
			//opponentName  = (String)jcbNickList.getSelectedItem();
